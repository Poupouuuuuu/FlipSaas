        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <label htmlFor="fab-image" className="flex flex-col items-center justify-center w-full h-24 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors overflow-hidden relative">
                {imagePreview ? (
