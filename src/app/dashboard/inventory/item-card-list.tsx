...
import { markItemAsSoldOrTransit, deleteItem } from './actions'
  ...
  return (
    <Card className="flex flex-col overflow-hidden group">
      <div className="relative aspect-square bg-slate-100 dark:bg-slate-800">
        ...
        <div className="absolute top-2 right-2 bg-black/60 text-white px-2 py-1 rounded text-xs font-medium backdrop-blur-sm">
      ...
      <CardFooter className="p-0 border-t flex">
        ...
        {/* Small delete icon hidden on hover */}
        <Button 
          variant="ghost" 
          size="icon" 
          className="absolute opacity-0 group-hover:opacity-100 -top-1 -right-1 bg-white/90 dark:bg-slate-900/90 hover:bg-red-100 hover:text-red-500 h-8 w-8 rounded-full shadow-sm"
